...
describe('WebdriverIO site test', () => {
  it('should open the WebdriverIO main page', async () => {
    await browser.url('https://webdriver.io/');
    const currentUrl = await browser.getUrl();
    expect(currentUrl).toContain('webdriver.io');
  });

  it('should navigate to the API section via the top menu', async () => {
    await browser.url('https://webdriver.io/');
  ...
  it('should display the correct H1 heading on the API page', async () => {
  ...
  it('should display the breadcrumb "Introduction" text', async () => {
    await browser.url('https://webdriver.io/docs/api');
  ...
  it('should verify element with attribute name "Webdriver" exists', async () => {
    await browser.url('https://webdriver.io/docs/api');
  ...
  it('should activate the search bar and type a query', async () => {
    await browser.url('https://webdriver.io/');
  ...
  it('should check if element isClickable', async () => {
    await browser.url('https://webdriver.io/');
  ...
  it('should scroll to footer Getting Started link on API page', async () => {
    await browser.url('https://webdriver.io/docs/api');
  ...
  it('should check if Protocol Commands link is enabled, is clickable, get HTML', async () => {
    await browser.url('https://webdriver.io/docs/api');
